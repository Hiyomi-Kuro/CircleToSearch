...
<!-- ---------- Badges ---------- -->
  <div align="center">
    ...
    <!-- <img alt="Downloads" src="https://img.shields.io/github/downloads/Kaori/CircleToSearch/total?color=c3e7ff&style=flat-square"> -->
    <img alt="Last commit" src="https://img.shields.io/github/last-commit/Kaori/CircleToSearch?color=c3e7ff&style=flat-square">
    <img alt="Repo size" src="https://img.shields.io/github/repo-size/Kaori/CircleToSearch?color=c3e7ff&style=flat-square">
    <!-- <img alt="Stars" src="https://img.shields.io/github/stars/Kaori/CircleToSearch?color=c3e7ff&style=flat-square"> -->
    <br>




  <img src="https://hits.sh/github.com/Kaori/CircleToSearch.svg?style=for-the-badge&label=Page%20Views&extraCount=360&color=ff3f6f&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%%2BPC9zdmc%2B&labelColor=870b2a"/>



<a href="https://github.com/Kaori/CircleToSearch/releases">

  <img src="https://img.shields.io/github/downloads/Kaori/CircleToSearch/total?color=ff9500&style=for-the-badge&logo=data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PHRpdGxlPmRvd25sb2FkPC90aXRsZT48cGF0aCBkPSJNNSwyMEgxOVYxOEg1TTE5LDlIMTVWM0g5VjlINUwxMiwxNkwxOSw5WiIgZmlsbD0id2hpdGUiIC8+PC9zdmc+&labelColor=a6660d"/>

</a>

<a href="https://github.com/Kaori/CircleToSearch/stargazers">

  <img src="https://img.shields.io/github/stars/Kaori/CircleToSearch?color=ffff00&style=for-the-badge&labelColor=a1a116&logo=data:image/svg+xml;base64,"/>
...
<div align="center">
  ...
  <a href="https://f-droid.org/packages/com.kaori.circletosearch/">
    <img src="https://fdroid.gitlab.io/artwork/badge/get-it-on.png"
         alt="Get it on F-Droid"
         height="80">
  </a>
  <a href="https://play.google.com/store/apps/details?id=com.kaori.circletosearch">
...
- 🐛 **Bug reports:** [GitHub Issues](https://github.com/Kaori/CircleToSearch/issues)
- 💡 **Feature requests:** [GitHub Issues](https://github.com/Kaori/CircleToSearch/issues)
- 👨‍💻 **Contribute:** Fork and submit pull requests
- ⭐ Star the repo
* 💬 Join the [Kaori Telegram group](https://t.me/Kaori)
* ☕ Maybe [**Donate**](https://github.com/sponsors/Kaori), if you can.


---

<p align="center">
  Made with ❤️ by <a href="https://github.com/kaori">Kaori</a>
</p>
