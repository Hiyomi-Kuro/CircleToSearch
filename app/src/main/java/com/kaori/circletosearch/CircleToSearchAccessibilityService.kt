...
import com.kaori.circletosearch.data.ActionType
import com.kaori.circletosearch.data.BitmapRepository
import com.kaori.circletosearch.data.GestureType
import com.kaori.circletosearch.data.OverlayConfigurationManager
import com.kaori.circletosearch.data.OverlaySegment
import com.kaori.circletosearch.ui.components.CopyTextOverlayManager
    ...
    private fun showPinnedActions(anchorView: View, bitmap: Bitmap, anchorParams: WindowManager.LayoutParams, onMenuCreated: (View) -> Unit) {
        ...
        menuLayout.addView(createTextActionButton(getString(R.string.pinned_btn_share)) {
            try {
                ...
                val uri = androidx.core.content.FileProvider.getUriForFile(this@CircleToSearchAccessibilityService, "com.kaori.circletosearch.fileprovider", file)
