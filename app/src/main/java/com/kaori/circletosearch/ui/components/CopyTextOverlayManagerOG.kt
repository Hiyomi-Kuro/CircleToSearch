...
// */
//
//package com.kaori.circletosearch.ui.components
//
...
//            val snapshot = com.kaori.circletosearch.CircleToSearchAccessibilityService.lastCapturedNodes
//            if (snapshot != null) {
//                android.util.Log.d("CopyText", "Using snapshot with ${snapshot.size} nodes")
//                detectedNodes.clear()
//                detectedNodes.addAll(snapshot)
//                com.kaori.circletosearch.CircleToSearchAccessibilityService.lastCapturedNodes = null
//                view.invalidate()
//                return@launch
//            }
//
